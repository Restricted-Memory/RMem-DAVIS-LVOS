...
class DefaultEngineConfig():
    def __init__(self, exp_name='default', model='aott'):
        ...
        self.DATA_RANDOM_GAP_LVOS = 30  # max frame interval between two sampled frames for LVOS
    ...
    def init_dir(self):
        ...
        self.DIR_DAVIS = os.path.join(self.DIR_DATA, 'DAVIS-2017')
        ...
        self.DIR_YTB = os.path.join(self.DIR_DATA, 'YouTubeVOS')
