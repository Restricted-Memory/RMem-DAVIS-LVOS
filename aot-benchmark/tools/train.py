...
def main_worker(gpu, cfg, enable_amp=True, log_dir=None):
...
def main():
    ...
    parser.add_argument('--use_temporal_pos_emb', action='store_true', default=False)
    ...
    if args.use_temporal_pos_emb:
        cfg.USE_TEMPORAL_POS_EMB = args.use_temporal_pos_emb
    ...
    if cfg.TRAIN_GPUS > 1:
        ...
        mp.spawn(main_worker, nprocs=cfg.TRAIN_GPUS, args=(cfg, args.amp, log_dir))
    else:
        cfg.TRAIN_GPUS = 1
        main_worker(0, cfg, args.amp, log_dir=log_dir)
