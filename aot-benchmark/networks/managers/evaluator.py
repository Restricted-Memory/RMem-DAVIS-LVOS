...
from dataloaders.eval_datasets import YOUTUBEVOS_Test, YOUTUBEVOS_DenseTest, DAVIS_Test, EVAL_TEST, LONG_VIDEOS_Test, LVOS_Test
...
class Evaluator(object):
    ...
    def prepare_dataset(self):
        ...
        eval_name = 'ckpt_{}'.format(self.ckpt)
    ...
    def evaluating(self):
        ...
        with torch.no_grad():
            for seq_idx, seq_dataset in enumerate(self.dataset):
                ...
                max_gap = int(round(num_frames / cfg.TEST_MAX_LONG_TERM_MEM_GAP))
                print(f"{max_gap = }")
                gap = max(max_gap, cfg.TEST_LONG_TERM_MEM_GAP)
